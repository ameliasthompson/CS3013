...
int addOption(struct option** cmds, int* size) {
	...
	return appendOption(cmds, size, pathStr, nameStr, "A user generated command.", headStr, defArgs, 0, 0);
}
...
int addOptionVerbose(struct option** cmds, int* size) {
	...
	// Append the option, and return what it does.
	return appendOption(cmds, size, pathStr, nameStr, descStr, headStr, NULL,  1, 1);
}
